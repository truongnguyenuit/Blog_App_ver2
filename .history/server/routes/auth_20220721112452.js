...
router.put('/update', verifyToken, async (req, res) => {
  ...
  try {
    ...
    return res.json({ success: true, message: "update complete", user })
  ...
  if (newPassword != confirmPassword)
    return res
      ...
      try {
        ...
        // All good
        const hashedPassword = await argon2.hash(password)const hashedPassword = await argon2.hash(password)
        res.json({ success: true, message: 'Login successfully', accessToken })
