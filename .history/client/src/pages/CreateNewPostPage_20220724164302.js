  ...
  return (
    <div className="pr-[60px] pl-[150px] pt-[50px]">
      ...
      <Row className="mt-5">
          <Col span={24}>
          <input
              className="w-[1000px] h-full p-2.5 text-[18px] font-normal  focus:outline-none border-2 border-black rounded-[10px]"
              type="text"
      ...
      <div>
        <textarea
          className=" mt-[15px] p-2.5 text-[18px] focus:outline-none border-2 border-black rounded-[10px]"
