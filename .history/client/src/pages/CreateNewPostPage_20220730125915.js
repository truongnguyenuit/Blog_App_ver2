...
const CreateNewPostPage = () => {
  ...
  return (
    <div className="pr-[60px] pl-[150px] pt-[50px]">
      <div className="w-[1075px] h-[300px]">
        <img
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <Row className="mt-1">
          <Col className="" span={18}>
            <input
              className=" p-2.5 w-full text-[18px] font-normal  focus:outline-none border-2 border-slate-300 rounded-[5px]"
              type="text"
              placeholder="Title"
          ...
          <Col className="" span={6}>
            <div className=" flex justify-start ml-1 text-[18px]">
              <button
                type="submit"
                className="px-4 py-2 bg-blue-500 text-white text-[18px] rounded-[5px]"
        ...
        <Row className="mt-1">
          <Col span={24}>
            <input
              className="w-[1075px] h-full p-2.5 text-[18px] font-normal  focus:outline-none border-2 border-slate-300 rounded-[5px]"
              type="text"
        ...
        <Row className="mt-1">
          <Col span={24}>
            <textarea
              className=" p-2.5 text-[18px] focus:outline-none border-2 border-slate-300 rounded-[5px]"
