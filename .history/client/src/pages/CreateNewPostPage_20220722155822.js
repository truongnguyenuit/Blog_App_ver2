        ...
        <Row className="h-[50px]">
          <Col className=" m-auto text-center" span={1}>
            <label htmlFor="inputImg">
              <i className="fa-solid fa-circle-plus text-[27px] cursor-pointer text-blue-600/100"></i>
              <input
                id="inputImg"
                className="hidden"
                type="file"
          ...
          <Col className="" span={17}>
            <input
              className="w-11/12 h-full p-2.5 text-[30px] font-normal  focus:outline-none border-2 border-black rounded-[10px]"
              type="text"
              placeholder="Title"
              name="title"
              value={title}
