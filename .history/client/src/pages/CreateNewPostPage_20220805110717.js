  ...
  return (
    <div className="pr-[60px] pl-[150px] pt-[50px]">
      <div className="w-[1075px] h-[300px]">
        <img
          className="w-[100px] h-full object-cover rounded-[5px]"
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <Row className="mt-1">
          ...
          <Col className="" span={6}>
            <div className="flex justify-start ml-1 ">
              <button
                type="submit"
                className="p-2.5  bg-blue-500 border-2 text-white text-[18px] rounded-[5px]"
        ...
        <Row className="mt-1">
          <Col span={24}>
            <input
              className="p-2.5 w-[1075px] text-[18px] font-normal  focus:outline-none border-2 border-slate-300 rounded-[5px]"
              type="text"
