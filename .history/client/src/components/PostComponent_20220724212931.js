...
const PostComponent = ({ title, description, img, user, time }) => {
  return (
    <div className="w-[430px] mx-6 my-2 p-[12px] flex flex-col bg-white drop-shadow-md rounded-[8px] overflow-hidden">
      <div className='flex'>
        ...
        <div className='flex flex-col justify-center ml-[10px] gap-2'>
