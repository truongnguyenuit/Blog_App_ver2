    ...
    <div className="w-[430px] mx-6 my-2 flex flex-col bg-white drop-shadow-md rounded-[8px] overflow-hidden">
      <div className='flex mt-[12px] ml-[12px] mr-[12px] '>
        ...
        <div className='w-[173px] flex justify-end gap-2'>
            ...
            <i class="fa-solid fa-pen-to-square text-xl text-red-600 cursor-pointer" onClick={showModal1} ></i>
      ...
      <Modal title="Alert" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
        <p className='text-red-'>Are you want to delete this blog?</p>
      </Modal>
      <Modal title="Update Blog" visible={isModalVisible1} onOk={handleOk} onCancel={handleCancel}>
        <p>Some contents...</p>
        <p>Some contents...</p>
        <p>Some contents...</p>
      </Modal>
