  ...
  return (
    ...
    <div className="h-[50px]">
      <Row >
        ...
        <Col span={6}>
          <div className="flex justify-center items-center text-[20px] gap-1.5 h-10 bg-sky-500">
        ...
        <Col span={12}>
          <nav>
            <ul className="flex justify-center items-center text-[17px] gap-1.5 h-10 bg-yellow-500">
        ...
        <Col span={6}>
          <div className="flex justify-center items-center gap-1.5 h-10 bg-yellow-500">
